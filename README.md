...
If you want to use non-press Touchpad for pedal, modifying KeyTouchDirectCenter in the config file from Unassigned to Mouse right button (and restarting app).
